...
String fname=request.getParameter("T3");
    ...
    String depend1=request.getParameter("C1");
    String depend2=request.getParameter("C2");
    String depend3=request.getParameter("C3");
    StringBuffer sb=new StringBuffer();
    String depend=sb.append(depend1).append(" ").append(depend2).append(" ").append(depend3).append(" ").toString(); 
    ...
    String assets=request.getParameter("C4");
